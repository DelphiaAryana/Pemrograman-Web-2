        ...
        <div class="container ">
            <div class="row justify-content-center">
                <div class="col-md-5 border rounded mt-2">
                    <form action="<?php echo e(route('data_skincare.update', $skincare->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo method_field('put'); ?>
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama</label>
                            <input type="text" class="form-control" id="nama" name="nama" value="<?php echo e($skincare->nama); ?>">
                        </div>

                        <div class="mb-3">
                          <label for="image" class="form-label">Upload Gambar</label>
                          <input type="file" class="form-control" id="image" name="image" value="<?php echo e($skincare->image); ?>">                         
                        </div>

                        <div class="mb-3">
                            <label for="fungsi" class="form-label">Fungsi</label>
                            <input type="text" class="form-control" id="fungsi" name="fungsi" value="<?php echo e($skincare->fungsi); ?>">                         
                        </div>

                        <div class="mb-3">
                            <label for="harga" class="form-label">Kisaran Harga</label>
                            <input type="text" class="form-control" id="harga" name="harga" value="<?php echo e($skincare->harga); ?>">                         
                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\TugasLaravel_Delphia\resources\views/edit_skincare.blade.php ENDPATH**/ ?>