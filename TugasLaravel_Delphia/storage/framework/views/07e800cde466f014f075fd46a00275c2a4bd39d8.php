  ...
  <div class="container-sidebar">
    ...
    <div class="main-content">
        ...
        <div class="data">
          ...
          <h2>Tabel Data Skincare</h2><br>

          <a href="<?php echo e(route('data_skincare.create')); ?>" class="btn btn-success">Tambah Data</a>
          ...
          <table class="table">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td><?php echo e($item->fungsi); ?></td>
                      <td><?php echo e($item->harga); ?></td>
                      <td>
                          <a href="<?php echo e(route('data_skincare.edit', $item->id)); ?>" class="btn btn-primary">Edit</a>
                          <form action="<?php echo e(route('data_skincare.destroy', $item->id)); ?>" method="POST" class="d-inline">
                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\TugasLaravel_Delphia\resources\views/data_skincare.blade.php ENDPATH**/ ?>