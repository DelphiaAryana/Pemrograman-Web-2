  ...
  <div class="container-sidebar">
    ...
    <div class="main-content">
        ...
        <div class="data">
          ...
          <a href="{{ route('data_skincare.create') }}" class="btn btn-success">Tambah Data</a>
          ...
          <table class="table">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>{{ $item->harga }}</td>
                      <td>
                          <a href="{{ route('data_skincare.edit', $item->id) }}" class="btn btn-primary">Edit</a>
                          <form action="{{ route('data_skincare.destroy', $item->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
